...
/**
 * Installation script to automatically enable the CNPJ plugin upon installation.
 */
class PlgFieldsCnpjInstallerScript
{
    /**
    ...
    private function enablePlugin(): void
    {
        try {
            ...
            $query = $db->getQuery(true)
                ...
                ->where($db->quoteName('element') . ' = ' . $db->quote('cnpj'));
