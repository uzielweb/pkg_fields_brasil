...
/**
 * Installation script to automatically enable the Hybrid CPF/CNPJ plugin upon installation.
 */
class PlgFieldsCpfcnpjInstallerScript
{
    /**
    ...
    private function enablePlugin(): void
    {
        try {
            ...
            $query = $db->getQuery(true)
                ...
                ->where($db->quoteName('element') . ' = ' . $db->quote('cpfcnpj'));
